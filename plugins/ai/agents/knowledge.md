...
Every entry at `.project/knowledge-entries/{type}/{ID}-{slug}.md`:
...
`.project/knowledge-entries/index.yaml`:
...
4. Format: "Past experience suggests: [LES-01] N+1 query patterns are common in Django list views. See `.project/knowledge-entries/lessons/LES-01-n+1-query-fix.md`"
