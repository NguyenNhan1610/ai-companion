...
- The FDR file path (e.g., `.claude/project/fdr/FDR-03-session-caching.md`)
...
- The IMPL file path (e.g., `.claude/project/implementation_plans/IMPL-03-session-caching.md`)
...
Wait for it to complete. Extract:
- The TODO file path (e.g., `.claude/project/todos/TODO-03-session-caching.yaml`)
