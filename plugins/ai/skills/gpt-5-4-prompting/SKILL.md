...
description: Internal prompt composition guide for Codex and GPT-5.4 tasks
user-invocable: false
---

# GPT-5.4 Prompting

Use this skill when `ai:codex-rescue` needs to ask Codex or another GPT-5.4-based workflow for help.
