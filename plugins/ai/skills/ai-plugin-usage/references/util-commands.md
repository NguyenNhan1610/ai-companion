...
Types: patterns, lessons, decisions, antipatterns. Auto-suggested when starting FDR/ADR/IMPL/debug. Saved to `.project/knowledge-entries/`.
...
Outputs: Traceability table, task completion, edge case/risk coverage, session timeline, file:line citations. Saved to `.project/handoff-records/`.
