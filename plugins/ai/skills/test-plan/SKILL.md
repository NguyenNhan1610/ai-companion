...
```bash
/ai:test-plan --from .project/feature-development-records/FDR-03-session-caching.md
/ai:test-plan --from .project/feature-development-records/FDR-03-session-caching.md --adr .project/architecture-decision-records/ADR-05-redis.md
```
...
Saved to `.project/test-plans/TP-{NN}-{slug}.md` with traceability matrices, coverage summary, and gap analysis.
